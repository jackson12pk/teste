...
// Corpo do email 
					...
					<a href="http://localhost/teste/recupera.php?cod='.$cod.'">Clique aqui para recuperar a senha.</a>
					'; 
...
// Exibe uma mensagem de resultado 
					if ($enviado) 
					{ 
						echo "<script>alert('Verifique seu e-mail para recuperar sua senha!');window.location.href='index.php'</script>"; 
					} else { 
